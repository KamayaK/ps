...
export function HeroSection() {
  ...
  return (
    <>
      <section className="relative min-h-screen bg-gradient-to-br from-[#3a3e24] via-[#2d3018] to-[#3a3e24] overflow-hidden">
        ...
        <nav className="relative z-20 h-20">
          ...
          ></div>
          <div className="absolute inset-0 bg-gradient-to-r from-[#3a3e24]/80 via-[#3a3e24]/60 to-[#3a3e24]/80"></div>
        ...
        <div className="absolute inset-0 opacity-15 mt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center w-full">
            ...
            <div className="text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start mb-6">
                ...
                <div>
                  <h1 className="text-4xl lg:text-5xl font-black text-white tracking-tighter leading-none drop-shadow-lg">
                    PRICE<span className="text-orange-500">SNIPER</span>
                  </h1>
              ...
              <h2 className="text-xl lg:text-2xl font-bold text-zinc-100 mb-6 uppercase tracking-wide drop-shadow-md">
                Elite Savings for DIY Warriors<br />
                <span className="text-orange-400">& Home Repair Frontliners</span>
              </h2>
              
              <p className="text-base text-zinc-200 mb-8 max-w-xl mx-auto lg:mx-0 drop-shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <button
                  onClick={() => openAuthModal('signup')}
                  className="border-2 border-zinc-300 hover:border-orange-500 text-white font-bold py-3 px-6 rounded-lg text-base uppercase tracking-wide transition-all duration-300 hover:bg-orange-500/20 backdrop-blur-sm"
                >
                  Deploy Now
                </button>
              </div>
              ...
              <div className="flex flex-wrap gap-6 mt-8 justify-center lg:justify-start">
                <div className="flex items-center">
                  ...
                  <span className="text-zinc-200 text-sm font-semibold uppercase drop-shadow-sm">System Online</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-orange-500 rounded-full mr-3"></div>
                  <span className="text-zinc-200 text-sm font-semibold uppercase drop-shadow-sm">Targets Acquired</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-blue-500 rounded-full mr-3"></div>
                  <span className="text-zinc-200 text-sm font-semibold uppercase drop-shadow-sm">Mission Ready</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative z-10">
                <img
                  ...
                  className="w-full h-80 lg:h-[500px] object-cover rounded-lg shadow-2xl border-4 border-zinc-600"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#3a3e24]/60 via-transparent to-transparent rounded-lg"></div>
                ...
                <div className="absolute bottom-4 left-4 bg-[#3a3e24]/90 backdrop-blur-sm p-4 rounded-lg border border-orange-500">
                  <div className="text-orange-500 font-black text-xl">PRECISION</div>
                  <div className="text-zinc-100 text-sm uppercase font-bold">Price Targeting</div>
                </div>
              </div>
              
              {/* Floating Stats Cards */}
              <div className="absolute -top-4 -left-4 bg-[#3a3e24] border border-orange-500 p-4 rounded-lg shadow-xl">
                <div className="text-orange-500 font-black text-2xl">2,847</div>
                <div className="text-zinc-200 text-xs uppercase font-bold">Active Targets</div>
              </div>
              
              <div className="absolute -bottom-4 -right-4 bg-[#3a3e24] border border-green-500 p-4 rounded-lg shadow-xl">
                <div className="text-green-500 font-black text-2xl">98.7%</div>
                <div className="text-zinc-200 text-xs uppercase font-bold">Mission Success</div>
              </div>
            </div>
          </div>
        </div>
