...
export function VideoSection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#3a3e24] via-[#2d3018] to-[#3a3e24]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-6">
            <Monitor className="w-8 h-8 text-orange-500 mr-3" />
            <h2 className="text-4xl font-black text-white uppercase tracking-tight drop-shadow-lg">
              Mission Briefing
            </h2>
          </div>
          <p className="text-xl text-zinc-100 max-w-3xl mx-auto drop-shadow-sm">
        ...
        {/* Video Container */}
        <div className="relative bg-zinc-800 rounded-lg overflow-hidden shadow-2xl border border-zinc-600">
            ...
            {!showVideo ? (
              ...
              <div className="w-full h-96 bg-gradient-to-br from-zinc-800 to-zinc-900 flex items-center justify-center">
                <div className="text-center">
                  <div 
                    className="w-24 h-24 bg-orange-600 rounded-full flex items-center justify-center mx-auto mb-6 hover:bg-orange-700 transition-colors duration-300 cursor-pointer group shadow-2xl"
              ...
              <div className="relative w-full h-96">
                ...
                <button
                  ...
                  className="absolute top-4 right-4 bg-[#3a3e24]/90 hover:bg-[#3a3e24] text-white p-2 rounded-full transition-colors duration-200 backdrop-blur-sm border border-zinc-500 shadow-lg"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#3a3e24]/95 to-transparent p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          <div className="bg-zinc-800 border border-zinc-600 p-6 rounded-lg text-center hover:border-orange-500 transition-colors duration-300 shadow-lg">
            <div className="text-3xl font-black text-orange-500 mb-2">15,000+</div>
            <div className="text-zinc-200 uppercase tracking-wide font-semibold">Views</div>
          </div>
          <div className="bg-zinc-800 border border-zinc-600 p-6 rounded-lg text-center hover:border-green-500 transition-colors duration-300 shadow-lg">
            <div className="text-3xl font-black text-green-500 mb-2">98%</div>
            <div className="text-zinc-200 uppercase tracking-wide font-semibold">Satisfaction</div>
          </div>
          <div className="bg-zinc-800 border border-zinc-600 p-6 rounded-lg text-center hover:border-blue-500 transition-colors duration-300 shadow-lg">
            <div className="text-3xl font-black text-blue-500 mb-2">4.9★</div>
            <div className="text-zinc-200 uppercase tracking-wide font-semibold">Rating</div>
          </div>
        </div>

        {/* Additional Training Resources */}
        <div className="mt-16 bg-zinc-800 border border-zinc-600 rounded-lg p-8 shadow-xl">
          <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-wide text-center">
            Additional Training Resources
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-[#3a3e24] border border-zinc-500 p-6 rounded-lg hover:border-orange-500 transition-colors duration-300 shadow-lg">
            ...
            <div className="bg-[#3a3e24] border border-zinc-500 p-6 rounded-lg hover:border-green-500 transition-colors duration-300 shadow-lg">
              <div className="flex items-center mb-4">
            ...
            <div className="bg-[#3a3e24] border border-zinc-500 p-6 rounded-lg hover:border-blue-500 transition-colors duration-300 shadow-lg">
              <div className="flex items-center mb-4">
